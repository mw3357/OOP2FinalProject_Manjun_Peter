...
public class MainActivity extends AppCompatActivity {
    ...
    public void initialData() {
        ...
        games.add(new Game("Cyberpunk 2077", "Genre: RPG", "Platform: PS4, XB1, PC", "Studio: CD Projekt Red", "Release Date: 09.17.2020", R.drawable.cyberpunk20771, R.drawable.cyberpunk20772, "Adapted from the Cyberpunk franchise, it takes place in dystopian Night City, an open world with six distinct regions. Players assume the role of the customisable mercenary V in a first-person perspective, acquiring skills in hacking and machinery, an arsenal of ranged weapons, and options for melee combat. Both lethal and non-lethal playthroughs are possible.", "https://www.ign.com/articles/cyberpunk-2077-will-be-around-for-a-long-time-unlocked-439"));
    }
